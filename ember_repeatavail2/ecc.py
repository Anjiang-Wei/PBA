...
def report_improve(ecc_res):
    ...
    print("ecc={\\")
    for key in res.keys():
        print(f"'{key}': {res[key][1]},")
    print("}")

# obtained from trans.py
raw_ber = {\
'25/ours' : 0.005729166666666666,
'25/SBA' : 0.007781862745098041,
'50/ours' : 0.005024509803921569,
'50/SBA' : 0.0070006127450980395,
'75/ours' : 0.004610906862745098,
'75/SBA' : 0.006786151960784313,
'90/ours' : 0.0037990196078431376,
'90/SBA' : 0.006709558823529411,
'100/ours' : 0.0036764705882352936,
'100/SBA' : 0.0070465686274509805,
}
error_spec = 1e-14
